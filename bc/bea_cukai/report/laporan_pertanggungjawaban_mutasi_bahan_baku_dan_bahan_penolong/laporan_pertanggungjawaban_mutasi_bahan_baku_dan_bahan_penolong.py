...
def get_columns():
	...
	columns = [
		{"label": _("Kode Barang"), "fieldname": "item_code", "fieldtype": "Link", "options": "Item", "width": 100},
		{"label": _("Nama Barang"), "fieldname": "item_name", "width": 150},
		{"label": _("Satuan"), "fieldname": "stock_uom", "fieldtype": "Link", "options": "UOM", "width": 90},
		{"label": _("Saldo Awal"), "fieldname": "opening_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
		{"label": _("Pemasukan"), "fieldname": "in_qty", "fieldtype": "Float", "width": 80, "convertible": "qty"},
		{"label": _("Pengeluaran"), "fieldname": "out_qty", "fieldtype": "Float", "width": 80, "convertible": "qty"},
		{"label": _("Saldo Akhir"), "fieldname": "bal_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
